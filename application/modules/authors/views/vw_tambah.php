                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control" placeholder="Nama penulis" id="first-name-icon" name="name" required>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control" placeholder="Gelar penulis" id="first-name-icon" name="title" required>
                                                            <div class="form-control-icon">
...
<script>
    $("#form-tambah").on("submit", function(e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>authors/submit_add',
            method: 'POST',
            dataType: 'JSON',
            processData: false,
            contentType: false,
