                            ...
                            <form class="form form-horizontal" id="form-edit" enctype="multipart/form-data" method="POST">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" placeholder="Category Blog" id="first-name-icon" name="category" required value="<?= $data['category'] ?>">
                                        ...
                                        <img src="<?= base_url('assets/uploads/') ?>category_images/<?= $data['img'] ?>" alt="" width="100px" class="mb-2">
...
<script>
    $("#form-edit").on("submit", function(e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>category_blogs/submit_edit',
            method: 'POST',
            dataType: 'JSON',
            processData: false,
            contentType: false,
