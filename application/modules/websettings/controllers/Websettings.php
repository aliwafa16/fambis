...
class Websettings extends MY_Controller
{
    ...
    {
        $data = $this->db->get_where('authors')->result_array();
        $results = [
            'draw' => 1,
    ...
    public function edit($uuid = NULL)
    {
        ...
        $data = [
            'title' => 'Edit Penulis',
            'sidebar' => 'author',
            'data'   => $this->db->get_where('authors', ['uuid' => $uuid])->row_array()
        ];
    ...
    public function submit_edit()
    {
        ...
        // get Data
        $dataOld = $this->db->get_where('authors', ['uuid' => $uuid])->row_array();
    ...
    public function hapus()
    {
        ...
        if ($this->db->trans_status() === FALSE) {
            ...
            $path = ASSETS_UPLOAD . 'authors/' . $data['images'];
            delete_image($path);
